  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg text-gray-700">
        ...
        <h4 className="text-lg font-medium text-gray-800 mt-4 mb-2">Tracking & Cookies Data</h4>
        ...
        <p>AlignRFP uses the collected data for various purposes:</p>
        <ul>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">3. Data Transfer</h2>
        ...
        <p>If you are located outside [Your Country/Region] and choose to provide information to us, please note that we transfer the data, including Personal Data, to [Your Country/Region] and process it there.</p>
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
        <p>AlignRFP will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">4. Disclosure of Data</h2>
        <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Legal Requirements</h3>
        <p>AlignRFP may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">5. Security of Data</h2>
        <p>The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>

        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">6. Service Providers</h2>
        <p>We may employ third party companies and individuals to facilitate our Service ("Service Providers"), to provide the Service on our behalf, to perform Service-related services or to assist us in analyzing how our Service is used. These third parties have access to your Personal Data only to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose.</p>

        <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">7. Links to Other Sites</h2>
